...
app.post('/api/initApplyForPayment', async(req, res) => {
    ...
    const data = {
        ...
        success_url: `${process.env.VITE_API_BASE_URL}/success`,
        fail_url: `${process.env.VITE_API_BASE_URL}/fail`,
        cancel_url: `${process.env.VITE_API_BASE_URL}/cancel`,
        ipn_url: `${process.env.VITE_API_BASE_URL}/ipn`,
